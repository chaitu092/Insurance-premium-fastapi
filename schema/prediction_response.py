...
# in fastapi, a response modek defines the structure of the data that your API endpoint will return 
# generating class api docs(/docs)
# validating output: so your api doesnt return malformed response
